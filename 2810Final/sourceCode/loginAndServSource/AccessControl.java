...
public class AccessControl {
    ...
    public static int returnRoleID(String rolename){
        ...
        if(rolename.toUpperCase().equals("WAREHOUSE")){
            
            return 100;
        } else if(rolename.toUpperCase().equals("SALESPERSON")){
            return 101;
        }
        return -1;
    }
    ...
    public static boolean isAllowed(String rolename, String branch){
       System.out.println("I AM RUNNING " + rolename);
        Connection keyConn;
        try{
        keyConn = DriverManager.getConnection(AccessControl.loginDatabase, "sampleuser", "CodeHaze1");
        ...
        if(rolename.toUpperCase() == "WAREHOUSE"){
              System.out.println("ALLOWING WAREHOUSE ACCESS");
              return true;
