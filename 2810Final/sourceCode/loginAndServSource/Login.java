...
public class Login extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int role = AccessControl.returnRoleID(roleName);
        String strRole = AccessControl.getRoleName(role);
         ...
         */ 
        if(authenticate(name, Helper.getPassword(pfPassword),branch) && AccessControl.isAllowed(strRole,branch)){
            dispose();
